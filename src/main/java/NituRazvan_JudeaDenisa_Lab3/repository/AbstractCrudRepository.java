...
public abstract class AbstractCrudRepository <ID, E extends NituRazvan_JudeaDenisa_Lab3.repository.HasID<ID>> implements NituRazvan_JudeaDenisa_Lab3.repository.CrudRepository<ID, E> {
