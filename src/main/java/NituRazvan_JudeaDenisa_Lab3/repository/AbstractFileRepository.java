...
public abstract class AbstractFileRepository<ID, E extends NituRazvan_JudeaDenisa_Lab3.repository.HasID<ID>> extends AbstractCrudRepository<ID, E> implements NituRazvan_JudeaDenisa_Lab3.repository.FileRepository<ID, E> {
